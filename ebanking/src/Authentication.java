...
public class Authentication extends JFrame {
	...
	public Authentication() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\IBank-master\\src\\images\\icons8-customer-16.png"));
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setBounds(382, 188, 31, 19);
		panel.add(lblNewLabel_1);
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\hp\\Downloads\\IBank-master\\src\\images\\icons8-key-2-16.png"));
		...
		JLabel lblCopyrightscThe = new JLabel("Copyrights(c) Vasumathi Narayanan 2019.");
		lblCopyrightscThe.setHorizontalAlignment(SwingConstants.TRAILING);
		lblCopyrightscThe.setFont(new Font("Tahoma", Font.PLAIN, 10));
		lblCopyrightscThe.setBounds(163, 306, 283, 23);
		getContentPane().add(lblCopyrightscThe);
